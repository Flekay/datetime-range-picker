    ...
    DateRangePicker.prototype = {
        ...
        updateElement: function () {
            ...
            if (this.startDate.format('Y') == this.endDate.format('Y')) {
                let data = this.startDate.format(this.locale.format).replace(this.startDate.format('Y'), '');
                newValue = data.replace(/^\W+|\W+$/g, '');
            }else{
            ...
            this.element.dispatchEvent(new CustomEvent('change.daterangepicker', {bubbles: true, detail: this}));
        },
